...
class ChatRequest(BaseModel):
    message: str
    model: str | None = None  # mantido só por compatibilidade, não usamos
    ...
    async function sendMessage() {
      ...
      try {
        ...
        try {
          ...
          append("Erro", "Resposta inválida do servidor.");
          return;
        }
...
async def chat(req: ChatRequest):
    """
    Recebe uma mensagem do usuário e chama o modelo Falcon3 via Transformers.
    """
    ...
    try:
        ...
        # Garante que os tensores estão no mesmo device do modelo
        ...
        # Corta a parte do input e pega só a continuação
