...
def normalize_one_line(text: str) -> str:
    """Colapsa quebras de linha e múltiplos espaços."""
...
def build_crypto_text(row: Dict) -> str:
    ...
    Usa JSON da linha inteira para não depender de nomes de colunas específicos.
    """
    # Serializa a linha inteira
...
def load_crypto_btc_usdt(limit=None, month_split=None):
    print("Carregando CryptoLM...")
    ...
    def _format(e):
        # e é um dict com todas as colunas numéricas da linha
        return {"text": build_crypto_text(e)}
...
def build_full_dataset(
    ...
    crypto_month_split: str = "2024-01.parquet",
):
    """
...
def parse_args():
    ...
    p.add_argument("--crypto_month_split", type=str, default=None,
                   help="Split do CryptoLM a usar, ex: 2024-01.parquet")
